...
// UbsUpdateUrmaBandwidth update the bandwidth range for a given URMA interface in Gbps.
//
// Parameters:
//   - ctx: the context for controlling request lifetime and cancellation
//   - name: the name of the URMA interface to set bandwidth for.
...
func UbsUpdateUrmaBandwidth(
	...
	cli := newUrmaClientFunc()
	return cli.updateBandwidth(ctx, name, minBandwidth, maxBandwidth)
}
