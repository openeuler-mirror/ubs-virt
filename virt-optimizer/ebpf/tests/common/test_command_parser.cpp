...
TEST_F(TestCommandParser, TestRegisterHandler)
{
    ...
    // 注册一个命令和处理函数
    parser->registerHandler("test", [&handler_called]() {
        handler_called = true;
        return true;
    }, "Test command");
...
{
    // 注册两个命令，一个带帮助信息，一个不带
    parser->registerHandler("cmd1", []() { return true; }, "Command 1 help");
    parser->registerHandler("cmd2", []() { return true; }, "");
...
{
    parser->registerHandler("test", []() { return false; }, "");
...
{
    parser->registerHandler("cmd", []() { return true; }, "");
...
{
    parser->registerHandler("cmd", []() { return true; }, "This is help");
