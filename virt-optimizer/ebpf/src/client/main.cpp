...
int main(int argc, char** argv)
{
    ...
    parser.registerHandler("start_ebpf", [] () -> bool {
    ...
    parser.registerHandler("stop_ebpf", [] () -> bool {
        if (!utils::checkRunning(PID_FILE_PATH, CLI_NAME)) {
    ...
    parser.registerHandler("reload_ebpf", [] () -> bool {
        if (!utils::checkRunning(PID_FILE_PATH, CLI_NAME)) {
        ...
        return true;
    }, "Reload the config file from the disk.");
