...
rt_entry_t rt_library_entry[] = {
    ...
    {.name = "rtFreePhysical"},   // mem-swap 扩展符号
    {.name = "aclrtMallocPhysicalImpl"},
    {.name = "rtMemGetInfoEx"},                // runtime标识待废弃
    {.name = "rtMallocHost"},                  // mem-swap 扩展符号
    {.name = "rtFreeHost"},                    // mem-swap 扩展符号
    {.name = "rtReserveMemAddress"},           // mem-swap 扩展符号
    {.name = "rtReleaseMemAddress"},           // mem-swap 扩展符号
    {.name = "rtMapMem"},                      // mem-swap 扩展符号
    {.name = "rtUnmapMem"},                    // mem-swap 扩展符号
    {.name = "rtMemcpy"},                      // mem-swap 扩展符号
    {.name = "rtsPointerGetAttributes"},       // mem-swap 扩展符号
    {.name = "rtMemcpyAsync"},                 // mem-swap 扩展符号
    {.name = "rtMemGetAllocationGranularity"}, // mem-swap 扩展符号
    {.name = "rtFree"},                        // mem-swap 扩展符号
    {.name = "rtsCheckMemType"},               // mem-swap 扩展符号
    {.name = "rtMemcpyAsyncEx"},               // mem-swap 扩展符号
    {.name = "rtsMemcpyBatch"},                // mem-swap 扩展符号
    {.name = "rtsMemcpyBatchAsync"},           // mem-swap 扩展符号
    {.name = "rtMemcpy2d"},                    // mem-swap 扩展符号
    {.name = "rtMemcpy2dAsync"},               // mem-swap 扩展符号
    {.name = "rtsSetMemcpyDesc"},              // mem-swap 扩展符号
    {.name = "rtsMemcpyAsyncWithDesc"},        // mem-swap 扩展符号
    {.name = "rtMemcpyAsyncWithOffset"},       // mem-swap 扩展符号
    {.name = "rtMemset"},                      // mem-swap 扩展符号
    {.name = "rtMemsetAsync"},                 // mem-swap 扩展符号
    {.name = "rtMemPrefetchToDevice"},         // mem-swap 扩展符号
    {.name = "rtsIpcMemGetExportKey"},         // mem-swap 扩展符号
    {.name = "rtsIpcMemImportByKey"},          // mem-swap 扩展符号
    {.name = "rtsValueWrite"},                 // mem-swap 扩展符号
    {.name = "rtsValueWait"},                  // mem-swap 扩展符号
