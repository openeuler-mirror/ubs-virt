...
#define SUB_MODULE_NAME "eNPU_MANAGER"
...
extern int log_set_config(const char *log_dir, const char *log_level, size_t max_file_size, int max_backup_count,
                          int max_log_age);
extern void log_set_console_output(bool enable);
